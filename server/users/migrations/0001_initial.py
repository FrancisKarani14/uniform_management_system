    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Tailor', 'Tailor'), ('School_Admin', 'School Admin'), ('Parent', 'Parent'), ('Student', 'Student')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.CharField(max_length=15)),
                ('school', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='school_admin_profile', to='schools.school')),
