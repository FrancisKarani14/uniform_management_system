...
export default function ParentProfileForm({ user }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await API.post('/users/parent_profiles/', {
        user: user.id,
        ...formData
      });
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Complete Your Parent Profile</h2>
