...
export default function SchoolAdminProfileForm({ user }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await API.post('/users/school_admin_profiles/', {
        user: user.id,
        ...formData
      });
      navigate('/school-admin-dashboard/profile');
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Complete Your School Admin Profile</h2>
