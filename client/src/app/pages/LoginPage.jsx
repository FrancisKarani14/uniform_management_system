      ...
      >
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-blue-700 text-white rounded-md font-medium hover:bg-blue-800 transition-all"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 py-3 bg-gray-100 text-gray-700 rounded-md font-medium hover:bg-gray-200 transition-all text-sm border-black border-b-4"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                type="button"
                className="flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-md hover:bg-gray-50 transition-all"
              >
          ...
          {showMagicLinkModal && (
            <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
              <div className="pointer-events-auto bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl border border-gray-200">
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Continue with Email</h3>
                <p className="text-gray-600 mb-4">Enter your email to receive a magic link</p>
