      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute w-full h-full flex items-center px-16 pt-24">
          <div className="max-w-2xl">
            ...
            <p className="hidden md:block text-xl leading-relaxed mb-8 text-white md:text-black font-semibold">
            ...
            <button 
              ...
              className="mt-4 md:mt-0 px-6 py-2 bg-blue-700 text-white rounded-lg text-lg font-semibold hover:bg-blue-800 hover:-translate-y-0.5 transition-all shadow-lg shadow-blue-700/30 hover:shadow-xl hover:shadow-blue-700/40"
            >
              Get Started
            </button>
          </div>
