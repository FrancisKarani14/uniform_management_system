export default function MyStudents() {
  const students = [
    { id: 1, name: 'John Doe', school: 'Greenwood High School', grade: 'Grade 8' },
    { id: 2, name: 'Jane Doe', school: 'Greenwood High School', grade: 'Grade 10' },
    { id: 3, name: 'Mike Doe', school: 'Sunrise Academy', grade: 'Grade 6' }
  ];

  return (
    <div>
      <h2 className="text-3xl font-bold mb-8 text-gray-900">My Students</h2>
